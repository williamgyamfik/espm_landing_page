...
const Footer = () => {
  ...
  return (
    ...
    <footer className="footer p-10 bg-gray-100 text-blue-900 items-start">
      <div className="items-start w-64">
        <Image src={companyLogo} alt="company logo here" />
        <p>
          Copyright © {year} - All right reserved by Euphoria Sports Management
          (ESPM)
        </p>
      ...
      {/* <aside>
        <div className="items-start w-64">
          <Image src={companyLogo} alt="company logo here" />
          <p>
            Copyright © {year} - All right reserved by Euphoria Sports
            Management (ESPM)
          </p>
        </div>
      </aside> */}
